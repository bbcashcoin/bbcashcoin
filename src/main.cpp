...
uint256 hashGenesisBlock("0x51e2456cd6ea23ed69301d1c859d98040137c928ed447220fa01bf28280a49a9");
...
const string strMessageMagic = "BBCashCoin Signed Message:\n";
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // BBCashCoin: 1 days
static const int64 nTargetSpacing = 120; // BBCashCoin: 2 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal bbcashcoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "BBCashCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "France did vote for more Europe last Sunday";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1494404220; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 362147;

        if (fTestNet)
        {
            block.nTime    = 1494404220;
            block.nNonce   = 362147;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x16a8d46f2fd2204076bae233a2acd4fd19e9524f4ce4802c76173a4f890a2f6b"));
